...
| 系列 | 内容 | 适合什么时候读 |
|---|---|---|
| ⭐ [Theme 主题开发完全教程](docs/theme/README.md)(12 篇) | 08 号文档 Theme 部分的完整展开:环境 → Liquid → 架构 → Section/Block → 商品/购物车/Ajax → Metafields → 多语言 → 性能 → 部署,含两周实战「北纬咖啡」与速查表;基于本仓库 `my-new-theme/`(Skeleton)实操 | 决定先走 Theme 线时,作为主线教程,替代 08 的第三部分 |
