...
```mermaid
graph TD
    S0["阶段 0：环境与领域模型<br/>第 1-2 周，共 2 周"] --> S1["阶段 1：React 核心<br/>第 3-5 周，共 3 周"]
    S1 --> S2["阶段 2：TypeScript + GraphQL<br/>第 6-8 周，共 3 周"]
    S2 --> S3["阶段 3：React Router 7<br/>第 9-10 周，共 2 周"]
    S3 --> S4["阶段 4：Shopify App 实战<br/>第 11-16 周，共 6 周"]
    S4 --> S5["阶段 5：上架与工程化<br/>第 17-19 周，共 3 周"]
    S5 -.-> S6["阶段 6：Hydrogen（可选）<br/>第 20-23 周，共 4 周"]
```
